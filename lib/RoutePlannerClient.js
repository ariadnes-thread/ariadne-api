...
class RoutePlannerClient {
    ...
    planRoute(constraints) {
        ...
        // Let it error instead.
        // if (!constraints.origin) constraints.origin = {latitude: 0, longitude: 0};
        // if (!constraints.destination) constraints.destination = {latitude: 0, longitude: 0};
